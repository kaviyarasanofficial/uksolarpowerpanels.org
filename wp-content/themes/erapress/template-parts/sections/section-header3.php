 <!--===// Start: Preloader
    =================================-->
	<?php  
		$tlh_header_info_text 				= get_theme_mod( 'tlh_header_info_text','Are you ready to grow up your business?'); 
		$tlh_header_title_info 				= get_theme_mod( 'tlh_header_title_info','Contact Us'); 
		$tlh_header_title_info_link 		= get_theme_mod( 'tlh_header_title_info_link','#'); 		
	...
	<header class="header header-3">
        <div class="top-header top-header-3">
            <div class="container text-center">
                <div class="row header-menu header-menu-3 ">
                    <div class="col-lg-6 col-md-6 ">
                        <div class="left-area">
							<?php if(!empty($tlh_header_info_text)){ ?>
								<div class="contact">
									<p class="mb-0">
										<?php echo esc_html($tlh_header_info_text); ?>
									</p>
								</div>
							<?php } ?>
							
							<?php if(!empty($tlh_header_title_info)){ ?>
								<div class="contact-link">
									<a href="<?php echo esc_url($tlh_header_title_info_link); ?>"><?php echo esc_html($tlh_header_title_info); ?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
								</div>
							<?php } ?>
                        </div>
                    </div>
                            ...
                            <div class="mail">
                                <div class=" contact-widget ">
                                    <aside class="widget widget-contact ">
                                        ...
                                        <div class="contact-area">
                                            <div class="contact-icon">
                                                <div class="fa <?php echo esc_attr(get_theme_mod('tlh_email_icon','fa-phone'));?>" style="color: var(--primary-color);"></div>
                                            </div>
                                            <a href="#" class="contact-info">
                                                <span style="color: #363636;font-weight: 600;" class="tlh_email_title"><?php echo esc_html($tlh_email_title);?></span>
                                            </a>
                                        </div>
										<?php } ?>
                                    </aside>
        ...
        <!-- Main  Naviagtion  ===============================================================-->
        <div class="top-navigation top-navigation-3 <?php echo esc_attr(erapress_sticky_menu()); ?>">
            <div class="container">
                <div class="row navigation-bar navigation-bar-3">
                            ...
                            <?php 
								wp_nav_menu( 
									array(  
										...
										'container'  => '',
										'menu_class' => 'navbar-menu navbar-menu-3',
