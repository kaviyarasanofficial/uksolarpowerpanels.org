 <!--===// Start: Preloader
    ...
    <header class="header">
                ...
                <div class="row header-menu">
                    <div class="col-lg-6 col-md-4">
                        <div class="widget-left">
							...
							<?php }
							if(!empty($tlh_email_title) && $hide_show_email_details == '1' ){ 
							?>	
                                <div class="contact-area">
                                    <div class="contact-icon">
        ...
        <div class="top-navigation <?php echo esc_attr(erapress_sticky_menu()); ?>">
            <div class="container">
									...
									<?php if(!empty($tlh_mobile_title) && $hide_show_mbl_details == '1') { ?>
										<div class="contact-widget">
											<aside class="widget widget-contact">
												<div class="contact-area">
													<div class="contact-icon">
														<div class="fa <?php echo esc_attr(get_theme_mod('tlh_mobile_icon','fa-map-marker'));?>"></div>
														
													</div>
													<a href="#" class="contact-info">
														<span class="tlh_mobile_title"> <?php echo esc_html($tlh_mobile_title);?></span>
													</a>
												</div>
