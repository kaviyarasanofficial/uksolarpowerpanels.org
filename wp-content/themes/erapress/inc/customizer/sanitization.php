 ...
 */
function erapress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function erapress_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function erapress_sanitize_html( $html ) {
 ...
 */
function erapress_sanitize_image( $image, $setting ) {
 ...
 */
function erapress_sanitize_number_absint( $number, $setting ) {
 ...
 */
function erapress_sanitize_select( $input, $setting ) {
 ...
 */
function erapress_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function erapress_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function erapress_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function erapress_sanitize_sortable( $val, $setting ) {
...
function erapress_sanitize_typography_fonts( $input ) {
	$standard = erapress_font_selector_get_standard_fonts();
	$google = erapress_font_selector_get_google_fonts_array();
 ...
 */
function erapress_sanitize_alpha_color( $val ) {
		if ( '' === $val ) { return ''; }
