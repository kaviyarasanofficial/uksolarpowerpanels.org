 ...
 */
	...
	wp.customize.controlConstructor['erapress-sortable'] = wp.customize.Control.extend({
...
/**
 *Erapress Radio Image
 */
 
jQuery( document ).ready( function() {
	jQuery( '.customize-control-erapress-radio-image' ).buttonset();
} );
...
( function( $ ) {
	...
	wp.customize.controlConstructor['erapress-color'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			this.container.find('.erapress-color-picker-alpha' ).wpColorPicker({
				/**
