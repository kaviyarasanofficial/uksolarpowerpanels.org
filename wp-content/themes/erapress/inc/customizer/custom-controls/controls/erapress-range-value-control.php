 ...
 * @access public
 */
class Erapress_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Erapress_Customizer_Range_Control constructor.
	 *
 ...
 */
function erapress_sanitize_range_value( $input ) {
	if ( erapress_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function erapress_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
