...
/**
 * Erapress
 * Customizer Control: Erapress Radio Image control
 */

class Erapress_Customize_Control_Radio_Image extends Erapress_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'erapress-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="erapress-radio-image-select">
