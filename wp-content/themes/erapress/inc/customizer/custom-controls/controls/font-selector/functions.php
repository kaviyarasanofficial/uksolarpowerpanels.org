...
require ERAPRESS_PARENT_INC_DIR . '/customizer/custom-controls/controls/font-selector/class/class-font-selector.php';
/**
 * List of standard fonts
 */
function erapress_font_selector_get_standard_fonts() {
	return apply_filters(
		'erapress_font_selector_standard_fonts_array', array(
 ...
 * @since 1.1.38
 */
function erapress_font_selector_enqueue_google_font( $font ) {
