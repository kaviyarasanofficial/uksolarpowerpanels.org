(function ($) {
    ...
    wp.erapresscustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                erapress_pro_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.erapresscustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.erapresscustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.erapresscustomizerRepeater.iconPickerToggle($(this));
        });
