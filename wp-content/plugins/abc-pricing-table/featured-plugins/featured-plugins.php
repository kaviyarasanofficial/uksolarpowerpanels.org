...
wp_enqueue_style( 'awl-bootstrap-css', APT_PLUGIN_URL . 'css/bootstrap.css' );
wp_enqueue_script( 'awl-bootstrap-js', APT_PLUGIN_URL . 'js/bootstrap.js', array( 'jquery' ), '', true );
wp_enqueue_style( 'thickbox' );
wp_enqueue_style( 'fp-bootstrap-css', APT_PLUGIN_URL . 'featured-plugins/css/bootstrap.css' );
wp_enqueue_style( 'fp-smartech-css', APT_PLUGIN_URL . 'featured-plugins/css/smartech.css' );
wp_enqueue_style( 'fp-feature-plugins', APT_PLUGIN_URL . 'featured-plugins/css/feature-plugins.css' );
wp_enqueue_script( 'jquery' );
wp_enqueue_script( 'fp-media-uploads', APT_PLUGIN_URL . 'js/featured-plugins/acl-media-upload-script.js', array( 'media-upload', 'thickbox', 'jquery' ) );
wp_enqueue_script( 'fp-bootstrap-min-js', APT_PLUGIN_URL . 'js/featured-plugins/bootstrap.min.js' );
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											<a href="https://awplife.com/premium-wordpress-plugins/" target="_blank" class="btn btn-info"> Upgrade </a>
										</div>
									</div>
									<hr>
								</div>
